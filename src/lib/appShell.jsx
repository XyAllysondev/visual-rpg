...
import { HeraldicStyles } from "../themes/heraldica";
  ...
  <style>{`
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    ...
    /* Fallback de boot (spec 0023). O registry (themes/index.js, via <ThemeStyles/>)
       ...
       Merge de 2026-08-14: este bloco morava no componente G do App.jsx
       monolítico da linha visual e veio para cá, que é onde ele passou a
       viver depois da spec 0031. Sem esta cópia, o merge teria deixado a
       repaginação de pé no registry mas com o primeiro frame ainda cinza.
...
/* Merge de 2026-08-14: `<HeraldicStyles/>` é a terceira camada, e vem por
   último de propósito — material, ornamento e movimento da repaginação
   precisam vencer o fallback de boot e o registry, não o contrário. Na linha
   visual esta linha era `Shell = (<><G/><ThemeStyles/><HeraldicStyles/></>)`
   dentro do App.jsx monolítico; aqui é o mesmo Shell, no lugar novo. */
