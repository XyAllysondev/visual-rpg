...
/* Hooks de viewport. Saíram do App.jsx (spec 0031, onda C): o `useViewportWidth` continua
   servindo a navegação mobile do App e o `useIsMobile` passou a ser usado pela
   `features/ficha/FullSheet`. Um módulo só para os dois — cópia seria divergência (AC-7). */
