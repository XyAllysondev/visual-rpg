...
export function ForjaStyles() {
  ...
  .forja-grid-counters { display:grid; grid-template-columns:repeat(auto-fill,minmax(152px,1fr)); gap:10px; }
  .forja-grid-shortcuts{ display:grid; grid-template-columns:repeat(auto-fit,minmax(196px,1fr)); gap:12px; }
  ...
  .forja-wiki-body     { display:grid; grid-template-columns:200px 1fr; gap:20px; align-items:start; }
  ...
  @media(max-width:479px){
    .forja-grid-counters { grid-template-columns:repeat(2,1fr); }
