...
export const OrdemSheetStyles = () => (
  <style>{`
    ...
    /* A transição pós-escolha vive em ElementoRitual.jsx (coreografia por
       ...
       Merge de 2026-08-14: a linha visual tinha trocado o literal da paleta
       velha no fallback por var(--bg) aqui. Como o bloco mudou de casa, a
       mesma troca foi aplicada no destino (ElementoRitual.jsx) — senão a
       paleta velha voltaria por baixo do pano.
       (Sem crase neste comentário: ele vive dentro de um template literal,
       e uma crase aqui fecharia a string.) */
